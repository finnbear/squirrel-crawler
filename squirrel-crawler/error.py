...
# Url errors
url_validated_error = 0
def urlValidatedError():
	global url_validated_error
	url_validated_error += 1
	output.console_warning("URL was already validated (" + str(url_validated_error) + ").")
